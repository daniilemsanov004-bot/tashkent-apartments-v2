 ...
 * агентство. Теперь считаем только ссылки, похожие на недвижимость (см.
 * REAL_ESTATE_SLUG_RE). ЭТОТ ФИКС УЖЕ ДЕЛАЛСЯ РАНЬШЕ И ПОТЕРЯЛСЯ ПРИ
 * СЛИЯНИИ С ДРУГОЙ ВЕТКОЙ ИЗМЕНЕНИЙ — если увидите снова, что все
 * категории считаются, проверьте, не затёрли ли этот блок повторно.
 *
